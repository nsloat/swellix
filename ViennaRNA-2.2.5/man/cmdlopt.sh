...
case $2 in
  --help)           gengetopt --show-help --set-version=2.2.5 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
  --version)        echo 2.2.5;;
  --detailed-help)  gengetopt --show-detailed-help --set-version=2.2.5 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
esac
