...
*eval_covar_structure2 = *RNAc::fold_compound_eval_covar_structure2;
...
sub VRNA_VC_TYPE_SINGLE () { $RNAc::VRNA_VC_TYPE_SINGLE }
sub VRNA_VC_TYPE_ALIGNMENT () { $RNAc::VRNA_VC_TYPE_ALIGNMENT }
