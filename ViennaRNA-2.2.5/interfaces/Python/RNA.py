...
def fc_add_pydata(vc, data, PyFunc):
...
def sc_add_pydata(vc, data, PyFunc):
...
class fold_compound(object):
    ...
    def add_auxdata(self, data, free_data):
    ...
    def sc_add_data(self, data, free_data):
    ...
    def constraints_add(self, constraint, options=1):
    ...
    def eval_covar_structure2(self, structure):
