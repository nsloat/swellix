 ...
 * Edit the original source file "energy_evaluation.ts" instead.
 */

#include <check.h>

#line 1 "energy_evaluation.ts"
...
int main(void)
{
    Suite *s1 = suite_create("Energy_Evaluating_Functions");
    TCase *tc1_1 = tcase_create("Energy_Evaluating_Functions");
    SRunner *sr = srunner_create(s1);
    int nf;

    suite_add_tcase(s1, tc1_1);
    tcase_add_test(tc1_1, eval_E_hairpin);
    tcase_add_test(tc1_1, eval_E_stem);
    tcase_add_test(tc1_1, eval_E_MLstem);
    tcase_add_test(tc1_1, eval_E_ExtLoop);
    tcase_add_test(tc1_1, eval_E_IntLoop);
