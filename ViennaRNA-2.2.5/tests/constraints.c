 ...
 * Edit the original source file "constraints.ts" instead.
 */

#include <check.h>

#line 1 "constraints.ts"
#include <math.h>
#include <stdio.h>
#include <unistd.h>
...
int main(void)
{
    ...
    tcase_add_test(tc1_1, test_vrna_sc_SHAPE_to_pr);
    tcase_add_test(tc1_1, test_vrna_file_SHAPE_read);
    tcase_add_test(tc1_1, test_vrna_sc_SHAPE_parse_method);
