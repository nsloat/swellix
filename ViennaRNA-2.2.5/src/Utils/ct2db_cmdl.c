...
const char *ct2db_args_info_usage = "Usage: ct2db [OPTIONS]... [FILES]...";

const char *ct2db_args_info_versiontext = "";

const char *ct2db_args_info_description = "Convert Zuker's .ct files to dot-bracket string\n";
...
void init_args_info(struct ct2db_args_info *args_info)
{
  ...
  args_info->removePK_help = ct2db_args_info_help[2] ;
  args_info->verbose_help = ct2db_args_info_help[3] ;
...
static void print_help_common(void) {
  ...
  if (strlen(ct2db_args_info_purpose) > 0)
    printf("\n%s\n", ct2db_args_info_purpose);

  if (strlen(ct2db_args_info_usage) > 0)
...
ct2db_cmdline_parser_dump(FILE *outfile, struct ct2db_args_info *args_info)
{
  ...
  if (args_info->removePK_given)
    write_into_file(outfile, "removePK", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVpv", long_options, &option_index);
...
.  */
          ...
          if (update_arg((void *)&(args_info->removePK_flag), 0, &(args_info->removePK_given),
              &(local_args_info.removePK_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "removePK", 'p',
              additional_error))
            goto failure;
