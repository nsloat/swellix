/*
  ...
  gengetopt -i RNAheat.ggo --file-name=RNAheat_cmdl --include-getopt --default-optional --func-name=RNAheat_cmdline_parser --arg-struct-name=RNAheat_args_info
...
init_full_help_array(void)
{
  ...
  RNAheat_args_info_full_help[12] = RNAheat_args_info_detailed_help[12];
  RNAheat_args_info_full_help[13] = RNAheat_args_info_detailed_help[13];
  RNAheat_args_info_full_help[14] = RNAheat_args_info_detailed_help[15];
  RNAheat_args_info_full_help[15] = RNAheat_args_info_detailed_help[17];
  RNAheat_args_info_full_help[16] = RNAheat_args_info_detailed_help[18];
  RNAheat_args_info_full_help[17] = RNAheat_args_info_detailed_help[19];
  RNAheat_args_info_full_help[18] = RNAheat_args_info_detailed_help[21];
  RNAheat_args_info_full_help[19] = RNAheat_args_info_detailed_help[23];
  RNAheat_args_info_full_help[20] = RNAheat_args_info_detailed_help[24];
  RNAheat_args_info_full_help[21] = 0; 
  
}

const char *RNAheat_args_info_full_help[22];
...
init_help_array(void)
{
  ...
  RNAheat_args_info_help[12] = RNAheat_args_info_detailed_help[12];
  RNAheat_args_info_help[13] = RNAheat_args_info_detailed_help[13];
  RNAheat_args_info_help[14] = RNAheat_args_info_detailed_help[15];
  RNAheat_args_info_help[15] = RNAheat_args_info_detailed_help[17];
  RNAheat_args_info_help[16] = RNAheat_args_info_detailed_help[18];
  RNAheat_args_info_help[17] = RNAheat_args_info_detailed_help[19];
  RNAheat_args_info_help[18] = RNAheat_args_info_detailed_help[24];
  RNAheat_args_info_help[19] = 0; 
  
}

const char *RNAheat_args_info_help[20];
...
void init_args_info(struct RNAheat_args_info *args_info)
{
  ...
  args_info->noTetra_help = RNAheat_args_info_detailed_help[12] ;
  args_info->dangles_help = RNAheat_args_info_detailed_help[13] ;
  args_info->noLP_help = RNAheat_args_info_detailed_help[15] ;
  args_info->noGU_help = RNAheat_args_info_detailed_help[17] ;
  args_info->noClosingGU_help = RNAheat_args_info_detailed_help[18] ;
  args_info->paramFile_help = RNAheat_args_info_detailed_help[19] ;
  args_info->nsp_help = RNAheat_args_info_detailed_help[21] ;
  args_info->energyModel_help = RNAheat_args_info_detailed_help[23] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVm:4d:P:e:", long_options, &option_index);
