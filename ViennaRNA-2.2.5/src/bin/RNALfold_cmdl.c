...
init_full_help_array(void)
{
  ...
  RNALfold_args_info_full_help[11] = RNALfold_args_info_detailed_help[13];
  RNALfold_args_info_full_help[12] = RNALfold_args_info_detailed_help[14];
  RNALfold_args_info_full_help[13] = RNALfold_args_info_detailed_help[15];
  RNALfold_args_info_full_help[14] = RNALfold_args_info_detailed_help[16];
  RNALfold_args_info_full_help[15] = RNALfold_args_info_detailed_help[17];
  ...
  RNALfold_args_info_full_help[18] = RNALfold_args_info_detailed_help[21];
  RNALfold_args_info_full_help[19] = RNALfold_args_info_detailed_help[23];
  ...
  RNALfold_args_info_full_help[22] = RNALfold_args_info_detailed_help[27];
  RNALfold_args_info_full_help[23] = RNALfold_args_info_detailed_help[29];
  RNALfold_args_info_full_help[24] = RNALfold_args_info_detailed_help[30];
  RNALfold_args_info_full_help[25] = 0; 
  
}

const char *RNALfold_args_info_full_help[26];
...
init_help_array(void)
{
  ...
  RNALfold_args_info_help[9] = RNALfold_args_info_detailed_help[10];
  RNALfold_args_info_help[10] = RNALfold_args_info_detailed_help[12];
  RNALfold_args_info_help[11] = RNALfold_args_info_detailed_help[13];
  RNALfold_args_info_help[12] = RNALfold_args_info_detailed_help[14];
  RNALfold_args_info_help[13] = RNALfold_args_info_detailed_help[15];
  RNALfold_args_info_help[14] = RNALfold_args_info_detailed_help[16];
  RNALfold_args_info_help[15] = RNALfold_args_info_detailed_help[17];
  ...
  RNALfold_args_info_help[18] = RNALfold_args_info_detailed_help[21];
  RNALfold_args_info_help[19] = RNALfold_args_info_detailed_help[23];
  RNALfold_args_info_help[20] = RNALfold_args_info_detailed_help[24];
  RNALfold_args_info_help[21] = RNALfold_args_info_detailed_help[25];
  RNALfold_args_info_help[22] = RNALfold_args_info_detailed_help[30];
...
void init_args_info(struct RNALfold_args_info *args_info)
{
  ...
  args_info->outfile_help = RNALfold_args_info_detailed_help[8] ;
  args_info->infile_help = RNALfold_args_info_detailed_help[10] ;
  args_info->zscore_help = RNALfold_args_info_detailed_help[14] ;
  args_info->gquad_help = RNALfold_args_info_detailed_help[15] ;
  args_info->temp_help = RNALfold_args_info_detailed_help[17] ;
  args_info->noTetra_help = RNALfold_args_info_detailed_help[18] ;
  args_info->dangles_help = RNALfold_args_info_detailed_help[19] ;
  args_info->noLP_help = RNALfold_args_info_detailed_help[21] ;
  args_info->noGU_help = RNALfold_args_info_detailed_help[23] ;
  args_info->noClosingGU_help = RNALfold_args_info_detailed_help[24] ;
  args_info->paramFile_help = RNALfold_args_info_detailed_help[25] ;
  args_info->nsp_help = RNALfold_args_info_detailed_help[27] ;
  args_info->energyModel_help = RNALfold_args_info_detailed_help[29] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVL:o:i:z::gT:4d:P:e:", long_options, &option_index);
