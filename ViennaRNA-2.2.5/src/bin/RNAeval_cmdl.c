...
init_help_array(void)
{
  ...
  RNAeval_args_info_help[17] = RNAeval_args_info_detailed_help[20];
  RNAeval_args_info_help[18] = RNAeval_args_info_detailed_help[22];
  RNAeval_args_info_help[19] = RNAeval_args_info_detailed_help[24];
  RNAeval_args_info_help[20] = 0; 
  
}

const char *RNAeval_args_info_help[21];
...
void init_args_info(struct RNAeval_args_info *args_info)
{
  ...
  args_info->shape_help = RNAeval_args_info_detailed_help[19] ;
  args_info->shapeMethod_help = RNAeval_args_info_detailed_help[20] ;
  args_info->shapeConversion_help = RNAeval_args_info_detailed_help[22] ;
