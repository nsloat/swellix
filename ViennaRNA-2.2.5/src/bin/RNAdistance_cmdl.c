/*
  ...
  gengetopt -i RNAdistance.ggo --file-name=RNAdistance_cmdl --include-getopt --default-optional --func-name=RNAdistance_cmdline_parser --arg-struct-name=RNAdistance_args_info
...
const char *RNAdistance_args_info_purpose = "Calculate distances between RNA secondary structures";

const char *RNAdistance_args_info_usage = "Usage: RNAdistance [OPTIONS]...";

const char *RNAdistance_args_info_versiontext = "";

const char *RNAdistance_args_info_description = "This program reads RNA secondary structures from stdin and calculates one or\nmore measures for their dissimilarity, based on tree or string editing\n(alignment). In addition it calculates a \"base pair distance\" given by the\nnumber of base pairs present in one structure, but not the other. For\nstructures of different length base pair distance is not recommended.\n";

const char *RNAdistance_args_info_detailed_help[] = {
...
{
  RNAdistance_args_info_help[0] = RNAdistance_args_info_detailed_help[0];
  RNAdistance_args_info_help[1] = RNAdistance_args_info_detailed_help[1];
  RNAdistance_args_info_help[2] = RNAdistance_args_info_detailed_help[2];
  RNAdistance_args_info_help[3] = RNAdistance_args_info_detailed_help[3];
  RNAdistance_args_info_help[4] = RNAdistance_args_info_detailed_help[5];
  RNAdistance_args_info_help[5] = RNAdistance_args_info_detailed_help[7];
  RNAdistance_args_info_help[6] = RNAdistance_args_info_detailed_help[8];
  RNAdistance_args_info_help[7] = RNAdistance_args_info_detailed_help[10];
  RNAdistance_args_info_help[8] = 0; 
  
}

const char *RNAdistance_args_info_help[9];

typedef enum {ARG_NO
  , ARG_FLAG
  , ARG_STRING
} RNAdistance_cmdline_parser_arg_type;

static
void clear_given (struct RNAdistance_args_info *args_info);
static
void clear_args (struct RNAdistance_args_info *args_info);

static int
RNAdistance_cmdline_parser_internal (int argc, char **argv, struct RNAdistance_args_info *args_info,
                        struct RNAdistance_cmdline_parser_params *params, const char *additional_error);
...
static
void init_args_info(struct RNAdistance_args_info *args_info)
{

  init_help_array(); 
  args_info->help_help = RNAdistance_args_info_detailed_help[0] ;
  args_info->detailed_help_help = RNAdistance_args_info_detailed_help[1] ;
  args_info->version_help = RNAdistance_args_info_detailed_help[2] ;
  args_info->distance_help = RNAdistance_args_info_detailed_help[3] ;
  args_info->compare_help = RNAdistance_args_info_detailed_help[5] ;
  args_info->shapiro_help = RNAdistance_args_info_detailed_help[7] ;
  args_info->backtrack_help = RNAdistance_args_info_detailed_help[8] ;
  
}

void
RNAdistance_cmdline_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(RNADISTANCE_CMDLINE_PARSER_PACKAGE_NAME) ? RNADISTANCE_CMDLINE_PARSER_PACKAGE_NAME : RNADISTANCE_CMDLINE_PARSER_PACKAGE),
     RNADISTANCE_CMDLINE_PARSER_VERSION);

  if (strlen(RNAdistance_args_info_versiontext) > 0)
    printf("\n%s\n", RNAdistance_args_info_versiontext);
}

static void print_help_common(void) {
  RNAdistance_cmdline_parser_print_version ();

  if (strlen(RNAdistance_args_info_purpose) > 0)
    printf("\n%s\n", RNAdistance_args_info_purpose);

  if (strlen(RNAdistance_args_info_usage) > 0)
    printf("\n%s\n", RNAdistance_args_info_usage);

  printf("\n");

  if (strlen(RNAdistance_args_info_description) > 0)
    printf("%s\n\n", RNAdistance_args_info_description);
}

void
RNAdistance_cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAdistance_args_info_help[i])
    printf("%s\n", RNAdistance_args_info_help[i++]);
}

void
RNAdistance_cmdline_parser_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
  while (RNAdistance_args_info_detailed_help[i])
    printf("%s\n", RNAdistance_args_info_detailed_help[i++]);
}

void
RNAdistance_cmdline_parser_init (struct RNAdistance_args_info *args_info)
{
...
void
RNAdistance_cmdline_parser_params_init(struct RNAdistance_cmdline_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
RNAdistance_cmdline_parser_params_create(void)
{
  struct RNAdistance_cmdline_parser_params *params = 
    (struct RNAdistance_cmdline_parser_params *)malloc(sizeof(struct RNAdistance_cmdline_parser_params));
  RNAdistance_cmdline_parser_params_init(params);  
  return params;
}
...
static void
RNAdistance_cmdline_parser_release (struct RNAdistance_args_info *args_info)
{
...
int
RNAdistance_cmdline_parser_dump(FILE *outfile, struct RNAdistance_args_info *args_info)
{
  int i = 0;
...
int
RNAdistance_cmdline_parser_file_save(const char *filename, struct RNAdistance_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  i = RNAdistance_cmdline_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
RNAdistance_cmdline_parser_free (struct RNAdistance_args_info *args_info)
{
  RNAdistance_cmdline_parser_release (args_info);
}
...
int
RNAdistance_cmdline_parser (int argc, char **argv, struct RNAdistance_args_info *args_info)
{
  return RNAdistance_cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
RNAdistance_cmdline_parser_ext (int argc, char **argv, struct RNAdistance_args_info *args_info,
                   struct RNAdistance_cmdline_parser_params *params)
{
  int result;
  result = RNAdistance_cmdline_parser_internal (argc, argv, args_info, params, 0);
...
int
RNAdistance_cmdline_parser2 (int argc, char **argv, struct RNAdistance_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct RNAdistance_cmdline_parser_params params;
...
int
RNAdistance_cmdline_parser_required (struct RNAdistance_args_info *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see RNAdistance_cmdline_parser_params.check_ambiguity
 * @param override @see RNAdistance_cmdline_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               RNAdistance_cmdline_parser_arg_type arg_type,
...
int
RNAdistance_cmdline_parser_internal (
  int argc, char **argv, struct RNAdistance_args_info *args_info,
                        struct RNAdistance_cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct RNAdistance_args_info local_args_info;
  ...
  if (initialize)
    RNAdistance_cmdline_parser_init (args_info);

  RNAdistance_cmdline_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVD:X:SB::", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ...
          RNAdistance_cmdline_parser_free (&local_args_info);
          exit (EXIT_SUCCESS);
        ...
        case 'D':	/* Specify the distance representation to be used in calculations.
.  */
        
        
          if (update_arg( (void *)&(args_info->distance_arg), 
               &(args_info->distance_orig), &(args_info->distance_given),
              &(local_args_info.distance_given), optarg, 0, "f", ARG_STRING,
...
.  */
          ...
          break;
        case 'S':	/* Use the Bruce Shapiro's cost matrix for comparing coarse structures.
        
.  */
        
        
          if (update_arg((void *)&(args_info->shapiro_flag), 0, &(args_info->shapiro_given),
              &(local_args_info.shapiro_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "shapiro", 'S',
              additional_error))
            goto failure;
        
          break;
        case 'B':	/* Print an \"alignment\" with gaps of the structures, to show matching substructures. The aligned structures are written to <filename>, if specified.
.  */
        ...
        case 0:	/* Long option with no short option */
          if (strcmp (long_options[option_index].name, "detailed-help") == 0) {
            RNAdistance_cmdline_parser_print_detailed_help ();
            RNAdistance_cmdline_parser_free (&local_args_info);
            exit (EXIT_SUCCESS);
          }
  ...
  RNAdistance_cmdline_parser_release (&local_args_info);
