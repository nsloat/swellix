...
init_full_help_array(void)
{
  ...
  RNAsubopt_args_info_full_help[13] = RNAsubopt_args_info_detailed_help[14];
  RNAsubopt_args_info_full_help[14] = RNAsubopt_args_info_detailed_help[15];
  RNAsubopt_args_info_full_help[15] = RNAsubopt_args_info_detailed_help[17];
  RNAsubopt_args_info_full_help[16] = RNAsubopt_args_info_detailed_help[19];
  ...
  RNAsubopt_args_info_full_help[24] = RNAsubopt_args_info_detailed_help[29];
  RNAsubopt_args_info_full_help[25] = RNAsubopt_args_info_detailed_help[30];
  RNAsubopt_args_info_full_help[26] = RNAsubopt_args_info_detailed_help[32];
  RNAsubopt_args_info_full_help[27] = RNAsubopt_args_info_detailed_help[34];
  RNAsubopt_args_info_full_help[28] = RNAsubopt_args_info_detailed_help[35];
  RNAsubopt_args_info_full_help[29] = RNAsubopt_args_info_detailed_help[36];
  RNAsubopt_args_info_full_help[30] = RNAsubopt_args_info_detailed_help[38];
  RNAsubopt_args_info_full_help[31] = RNAsubopt_args_info_detailed_help[40];
  RNAsubopt_args_info_full_help[32] = RNAsubopt_args_info_detailed_help[41];
  RNAsubopt_args_info_full_help[33] = RNAsubopt_args_info_detailed_help[43];
  RNAsubopt_args_info_full_help[34] = RNAsubopt_args_info_detailed_help[45];
  RNAsubopt_args_info_full_help[35] = RNAsubopt_args_info_detailed_help[46];
  RNAsubopt_args_info_full_help[36] = RNAsubopt_args_info_detailed_help[48];
  RNAsubopt_args_info_full_help[37] = RNAsubopt_args_info_detailed_help[50];
  RNAsubopt_args_info_full_help[38] = 0; 
  
}

const char *RNAsubopt_args_info_full_help[39];
...
init_help_array(void)
{
  ...
  RNAsubopt_args_info_help[13] = RNAsubopt_args_info_detailed_help[14];
  RNAsubopt_args_info_help[14] = RNAsubopt_args_info_detailed_help[15];
  RNAsubopt_args_info_help[15] = RNAsubopt_args_info_detailed_help[17];
  RNAsubopt_args_info_help[16] = RNAsubopt_args_info_detailed_help[19];
  RNAsubopt_args_info_help[17] = RNAsubopt_args_info_detailed_help[22];
  RNAsubopt_args_info_help[18] = RNAsubopt_args_info_detailed_help[23];
  ...
  RNAsubopt_args_info_help[25] = RNAsubopt_args_info_detailed_help[32];
  RNAsubopt_args_info_help[26] = RNAsubopt_args_info_detailed_help[34];
  RNAsubopt_args_info_help[27] = RNAsubopt_args_info_detailed_help[35];
  RNAsubopt_args_info_help[28] = RNAsubopt_args_info_detailed_help[36];
  RNAsubopt_args_info_help[29] = RNAsubopt_args_info_detailed_help[40];
  RNAsubopt_args_info_help[30] = RNAsubopt_args_info_detailed_help[41];
  RNAsubopt_args_info_help[31] = RNAsubopt_args_info_detailed_help[43];
  RNAsubopt_args_info_help[32] = RNAsubopt_args_info_detailed_help[45];
  RNAsubopt_args_info_help[33] = RNAsubopt_args_info_detailed_help[46];
  RNAsubopt_args_info_help[34] = RNAsubopt_args_info_detailed_help[50];
  RNAsubopt_args_info_help[35] = 0; 
  
}

const char *RNAsubopt_args_info_help[36];
...
void init_args_info(struct RNAsubopt_args_info *args_info)
{
  ...
  args_info->enforceConstraint_help = RNAsubopt_args_info_detailed_help[9] ;
  args_info->noconv_help = RNAsubopt_args_info_detailed_help[10] ;
  args_info->verbose_help = RNAsubopt_args_info_detailed_help[11] ;
  args_info->deltaEnergy_help = RNAsubopt_args_info_detailed_help[14] ;
  args_info->deltaEnergyPost_help = RNAsubopt_args_info_detailed_help[15] ;
  args_info->sorted_help = RNAsubopt_args_info_detailed_help[17] ;
  args_info->stochBT_help = RNAsubopt_args_info_detailed_help[19] ;
  args_info->pfScale_help = RNAsubopt_args_info_detailed_help[20] ;
  args_info->circ_help = RNAsubopt_args_info_detailed_help[22] ;
  args_info->dos_help = RNAsubopt_args_info_detailed_help[23] ;
  args_info->zuker_help = RNAsubopt_args_info_detailed_help[25] ;
  args_info->gquad_help = RNAsubopt_args_info_detailed_help[26] ;
  args_info->temp_help = RNAsubopt_args_info_detailed_help[28] ;
  args_info->noTetra_help = RNAsubopt_args_info_detailed_help[29] ;
  args_info->dangles_help = RNAsubopt_args_info_detailed_help[30] ;
  args_info->noLP_help = RNAsubopt_args_info_detailed_help[32] ;
  args_info->noGU_help = RNAsubopt_args_info_detailed_help[34] ;
  args_info->noClosingGU_help = RNAsubopt_args_info_detailed_help[35] ;
  args_info->logML_help = RNAsubopt_args_info_detailed_help[36] ;
  args_info->betaScale_help = RNAsubopt_args_info_detailed_help[38] ;
  args_info->shape_help = RNAsubopt_args_info_detailed_help[40] ;
  args_info->shapeMethod_help = RNAsubopt_args_info_detailed_help[41] ;
  args_info->shapeConversion_help = RNAsubopt_args_info_detailed_help[43] ;
  args_info->maxBPspan_help = RNAsubopt_args_info_detailed_help[45] ;
  args_info->paramFile_help = RNAsubopt_args_info_detailed_help[46] ;
  args_info->nsp_help = RNAsubopt_args_info_detailed_help[48] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVC::ve:sp:S:cDzgT:4d:P:", long_options, &option_index);
