...
init_full_help_array(void)
{
  ...
  RNALalifold_args_info_full_help[11] = RNALalifold_args_info_detailed_help[11];
  RNALalifold_args_info_full_help[12] = RNALalifold_args_info_detailed_help[12];
  RNALalifold_args_info_full_help[13] = RNALalifold_args_info_detailed_help[13];
  RNALalifold_args_info_full_help[14] = RNALalifold_args_info_detailed_help[14];
  RNALalifold_args_info_full_help[15] = RNALalifold_args_info_detailed_help[16];
  ...
  RNALalifold_args_info_full_help[18] = RNALalifold_args_info_detailed_help[20];
  RNALalifold_args_info_full_help[19] = RNALalifold_args_info_detailed_help[22];
  ...
  RNALalifold_args_info_full_help[22] = RNALalifold_args_info_detailed_help[26];
  RNALalifold_args_info_full_help[23] = RNALalifold_args_info_detailed_help[27];
  RNALalifold_args_info_full_help[24] = RNALalifold_args_info_detailed_help[28];
  RNALalifold_args_info_full_help[25] = RNALalifold_args_info_detailed_help[29];
  RNALalifold_args_info_full_help[26] = 0; 
  
}

const char *RNALalifold_args_info_full_help[27];
...
init_help_array(void)
{
  ...
  RNALalifold_args_info_help[11] = RNALalifold_args_info_detailed_help[11];
  RNALalifold_args_info_help[12] = RNALalifold_args_info_detailed_help[12];
  RNALalifold_args_info_help[13] = RNALalifold_args_info_detailed_help[13];
  RNALalifold_args_info_help[14] = RNALalifold_args_info_detailed_help[14];
  RNALalifold_args_info_help[15] = RNALalifold_args_info_detailed_help[16];
  RNALalifold_args_info_help[16] = RNALalifold_args_info_detailed_help[18];
  RNALalifold_args_info_help[17] = RNALalifold_args_info_detailed_help[19];
  RNALalifold_args_info_help[18] = RNALalifold_args_info_detailed_help[20];
  RNALalifold_args_info_help[19] = RNALalifold_args_info_detailed_help[25];
  RNALalifold_args_info_help[20] = RNALalifold_args_info_detailed_help[26];
  RNALalifold_args_info_help[21] = RNALalifold_args_info_detailed_help[27];
  RNALalifold_args_info_help[22] = RNALalifold_args_info_detailed_help[28];
  RNALalifold_args_info_help[23] = RNALalifold_args_info_detailed_help[29];
  RNALalifold_args_info_help[24] = 0; 
  
}

const char *RNALalifold_args_info_help[25];
...
void init_args_info(struct RNALalifold_args_info *args_info)
{
  ...
  args_info->mis_help = RNALalifold_args_info_detailed_help[10] ;
  args_info->temp_help = RNALalifold_args_info_detailed_help[12] ;
  args_info->noTetra_help = RNALalifold_args_info_detailed_help[13] ;
  args_info->dangles_help = RNALalifold_args_info_detailed_help[14] ;
  args_info->noLP_help = RNALalifold_args_info_detailed_help[16] ;
  args_info->noGU_help = RNALalifold_args_info_detailed_help[18] ;
  args_info->noClosingGU_help = RNALalifold_args_info_detailed_help[19] ;
  args_info->paramFile_help = RNALalifold_args_info_detailed_help[20] ;
  args_info->nsp_help = RNALalifold_args_info_detailed_help[22] ;
  args_info->energyModel_help = RNALalifold_args_info_detailed_help[24] ;
  args_info->cfactor_help = RNALalifold_args_info_detailed_help[25] ;
  args_info->nfactor_help = RNALalifold_args_info_detailed_help[26] ;
  args_info->ribosum_file_help = RNALalifold_args_info_detailed_help[27] ;
  args_info->ribosum_scoring_help = RNALalifold_args_info_detailed_help[28] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVL:T:4d:P:e:R:r", long_options, &option_index);
