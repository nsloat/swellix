/*
  ...
  gengetopt -i RNAplot.ggo --file-name=RNAplot_cmdl --include-getopt --default-optional --func-name=RNAplot_cmdline_parser --arg-struct-name=RNAplot_args_info
...
void init_args_info(struct RNAplot_args_info *args_info)
{
  ...
  args_info->help_help = RNAplot_args_info_help[0] ;
  args_info->version_help = RNAplot_args_info_help[1] ;
  args_info->layout_type_help = RNAplot_args_info_help[2] ;
  args_info->output_format_help = RNAplot_args_info_help[3] ;
  args_info->pre_help = RNAplot_args_info_help[4] ;
  args_info->post_help = RNAplot_args_info_help[5] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVt:o:", long_options, &option_index);
...
.  */
          if (strcmp (long_options[option_index].name, "pre") == 0)
          {
