/*
  ...
  gengetopt -i RNAaliduplex.ggo --file-name=RNAaliduplex_cmdl --include-getopt --default-optional --unamed-opts --func-name=RNAaliduplex_cmdline_parser --arg-struct-name=RNAaliduplex_args_info
...
void init_args_info(struct RNAaliduplex_args_info *args_info)
{
  ...
  args_info->noconv_help = RNAaliduplex_args_info_detailed_help[16] ;
  args_info->nsp_help = RNAaliduplex_args_info_detailed_help[17] ;
  args_info->paramFile_help = RNAaliduplex_args_info_detailed_help[19] ;
