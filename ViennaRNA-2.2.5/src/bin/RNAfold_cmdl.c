...
init_full_help_array(void)
{
  ...
  RNAfold_args_info_full_help[15] = RNAfold_args_info_detailed_help[17];
  RNAfold_args_info_full_help[16] = RNAfold_args_info_detailed_help[19];
  RNAfold_args_info_full_help[17] = RNAfold_args_info_detailed_help[21];
  RNAfold_args_info_full_help[18] = RNAfold_args_info_detailed_help[22];
  RNAfold_args_info_full_help[19] = RNAfold_args_info_detailed_help[23];
  RNAfold_args_info_full_help[20] = RNAfold_args_info_detailed_help[24];
  RNAfold_args_info_full_help[21] = RNAfold_args_info_detailed_help[26];
  ...
  RNAfold_args_info_full_help[25] = RNAfold_args_info_detailed_help[32];
  ...
  RNAfold_args_info_full_help[31] = RNAfold_args_info_detailed_help[43];
  RNAfold_args_info_full_help[32] = RNAfold_args_info_detailed_help[44];
  RNAfold_args_info_full_help[33] = RNAfold_args_info_detailed_help[45];
  RNAfold_args_info_full_help[34] = RNAfold_args_info_detailed_help[46];
  RNAfold_args_info_full_help[35] = RNAfold_args_info_detailed_help[47];
  RNAfold_args_info_full_help[36] = RNAfold_args_info_detailed_help[49];
  RNAfold_args_info_full_help[37] = RNAfold_args_info_detailed_help[51];
  RNAfold_args_info_full_help[38] = RNAfold_args_info_detailed_help[52];
  RNAfold_args_info_full_help[39] = RNAfold_args_info_detailed_help[53];
  RNAfold_args_info_full_help[40] = RNAfold_args_info_detailed_help[55];
  RNAfold_args_info_full_help[41] = RNAfold_args_info_detailed_help[57];
  RNAfold_args_info_full_help[42] = RNAfold_args_info_detailed_help[58];
  RNAfold_args_info_full_help[43] = RNAfold_args_info_detailed_help[60];
  RNAfold_args_info_full_help[44] = 0; 
  
}

const char *RNAfold_args_info_full_help[45];
...
init_help_array(void)
{
  ...
  RNAfold_args_info_help[12] = RNAfold_args_info_detailed_help[15];
  RNAfold_args_info_help[13] = RNAfold_args_info_detailed_help[16];
  RNAfold_args_info_help[14] = RNAfold_args_info_detailed_help[17];
  RNAfold_args_info_help[15] = RNAfold_args_info_detailed_help[19];
  RNAfold_args_info_help[16] = RNAfold_args_info_detailed_help[21];
  RNAfold_args_info_help[17] = RNAfold_args_info_detailed_help[22];
  RNAfold_args_info_help[18] = RNAfold_args_info_detailed_help[23];
  RNAfold_args_info_help[19] = RNAfold_args_info_detailed_help[24];
  RNAfold_args_info_help[20] = RNAfold_args_info_detailed_help[26];
  RNAfold_args_info_help[21] = RNAfold_args_info_detailed_help[30];
  RNAfold_args_info_help[22] = RNAfold_args_info_detailed_help[31];
  RNAfold_args_info_help[23] = RNAfold_args_info_detailed_help[32];
  RNAfold_args_info_help[24] = RNAfold_args_info_detailed_help[34];
  RNAfold_args_info_help[25] = RNAfold_args_info_detailed_help[38];
  RNAfold_args_info_help[26] = RNAfold_args_info_detailed_help[43];
  RNAfold_args_info_help[27] = RNAfold_args_info_detailed_help[44];
  RNAfold_args_info_help[28] = RNAfold_args_info_detailed_help[45];
  RNAfold_args_info_help[29] = RNAfold_args_info_detailed_help[46];
  RNAfold_args_info_help[30] = RNAfold_args_info_detailed_help[47];
  RNAfold_args_info_help[31] = RNAfold_args_info_detailed_help[49];
  RNAfold_args_info_help[32] = RNAfold_args_info_detailed_help[51];
  RNAfold_args_info_help[33] = RNAfold_args_info_detailed_help[52];
  RNAfold_args_info_help[34] = RNAfold_args_info_detailed_help[53];
  RNAfold_args_info_help[35] = RNAfold_args_info_detailed_help[60];
  RNAfold_args_info_help[36] = 0; 
  
}

const char *RNAfold_args_info_help[37];
...
void init_args_info(struct RNAfold_args_info *args_info)
{
  ...
  args_info->noPS_help = RNAfold_args_info_detailed_help[11] ;
  args_info->layout_type_help = RNAfold_args_info_detailed_help[12] ;
  args_info->noconv_help = RNAfold_args_info_detailed_help[13] ;
  args_info->maxBPspan_help = RNAfold_args_info_detailed_help[16] ;
  args_info->constraint_help = RNAfold_args_info_detailed_help[17] ;
  args_info->batch_help = RNAfold_args_info_detailed_help[19] ;
  args_info->canonicalBPonly_help = RNAfold_args_info_detailed_help[21] ;
  args_info->enforceConstraint_help = RNAfold_args_info_detailed_help[22] ;
  args_info->shape_help = RNAfold_args_info_detailed_help[23] ;
  args_info->shapeMethod_help = RNAfold_args_info_detailed_help[24] ;
  args_info->shapeConversion_help = RNAfold_args_info_detailed_help[26] ;
  args_info->motif_help = RNAfold_args_info_detailed_help[28] ;
  args_info->partfunc_help = RNAfold_args_info_detailed_help[32] ;
  args_info->MEA_help = RNAfold_args_info_detailed_help[34] ;
  args_info->pfScale_help = RNAfold_args_info_detailed_help[36] ;
  args_info->circ_help = RNAfold_args_info_detailed_help[38] ;
  args_info->ImFeelingLucky_help = RNAfold_args_info_detailed_help[39] ;
  args_info->bppmThreshold_help = RNAfold_args_info_detailed_help[41] ;
  args_info->gquad_help = RNAfold_args_info_detailed_help[43] ;
  args_info->temp_help = RNAfold_args_info_detailed_help[45] ;
  args_info->noTetra_help = RNAfold_args_info_detailed_help[46] ;
  args_info->dangles_help = RNAfold_args_info_detailed_help[47] ;
  args_info->noLP_help = RNAfold_args_info_detailed_help[49] ;
  args_info->noGU_help = RNAfold_args_info_detailed_help[51] ;
  args_info->noClosingGU_help = RNAfold_args_info_detailed_help[52] ;
  args_info->paramFile_help = RNAfold_args_info_detailed_help[53] ;
  args_info->nsp_help = RNAfold_args_info_detailed_help[55] ;
  args_info->energyModel_help = RNAfold_args_info_detailed_help[57] ;
  args_info->betaScale_help = RNAfold_args_info_detailed_help[58] ;
