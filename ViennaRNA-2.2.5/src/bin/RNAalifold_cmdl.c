...
init_full_help_array(void)
{
  ...
  RNAalifold_args_info_full_help[12] = RNAalifold_args_info_detailed_help[12];
  RNAalifold_args_info_full_help[13] = RNAalifold_args_info_detailed_help[13];
  RNAalifold_args_info_full_help[14] = RNAalifold_args_info_detailed_help[14];
  RNAalifold_args_info_full_help[15] = RNAalifold_args_info_detailed_help[16];
  RNAalifold_args_info_full_help[16] = RNAalifold_args_info_detailed_help[18];
  ...
  RNAalifold_args_info_full_help[19] = RNAalifold_args_info_detailed_help[22];
  ...
  RNAalifold_args_info_full_help[25] = RNAalifold_args_info_detailed_help[31];
  ...
  RNAalifold_args_info_full_help[32] = RNAalifold_args_info_detailed_help[40];
  RNAalifold_args_info_full_help[33] = RNAalifold_args_info_detailed_help[42];
  RNAalifold_args_info_full_help[34] = RNAalifold_args_info_detailed_help[43];
  ...
  RNAalifold_args_info_full_help[40] = RNAalifold_args_info_detailed_help[49];
  RNAalifold_args_info_full_help[41] = RNAalifold_args_info_detailed_help[50];
  RNAalifold_args_info_full_help[42] = RNAalifold_args_info_detailed_help[52];
  RNAalifold_args_info_full_help[43] = RNAalifold_args_info_detailed_help[54];
  RNAalifold_args_info_full_help[44] = RNAalifold_args_info_detailed_help[55];
  RNAalifold_args_info_full_help[45] = RNAalifold_args_info_detailed_help[57];
  RNAalifold_args_info_full_help[46] = 0; 
  
}

const char *RNAalifold_args_info_full_help[47];
...
init_help_array(void)
{
  ...
  RNAalifold_args_info_help[9] = RNAalifold_args_info_detailed_help[9];
  ...
  RNAalifold_args_info_help[13] = RNAalifold_args_info_detailed_help[14];
  RNAalifold_args_info_help[14] = RNAalifold_args_info_detailed_help[16];
  ...
  RNAalifold_args_info_help[17] = RNAalifold_args_info_detailed_help[21];
  RNAalifold_args_info_help[18] = RNAalifold_args_info_detailed_help[22];
  RNAalifold_args_info_help[19] = RNAalifold_args_info_detailed_help[24];
  RNAalifold_args_info_help[20] = RNAalifold_args_info_detailed_help[26];
  RNAalifold_args_info_help[21] = RNAalifold_args_info_detailed_help[27];
  RNAalifold_args_info_help[22] = RNAalifold_args_info_detailed_help[28];
  ...
  RNAalifold_args_info_help[29] = RNAalifold_args_info_detailed_help[40];
  RNAalifold_args_info_help[30] = RNAalifold_args_info_detailed_help[42];
  RNAalifold_args_info_help[31] = RNAalifold_args_info_detailed_help[43];
  RNAalifold_args_info_help[32] = RNAalifold_args_info_detailed_help[44];
  RNAalifold_args_info_help[33] = RNAalifold_args_info_detailed_help[45];
  RNAalifold_args_info_help[34] = RNAalifold_args_info_detailed_help[46];
  RNAalifold_args_info_help[35] = RNAalifold_args_info_detailed_help[47];
  RNAalifold_args_info_help[36] = RNAalifold_args_info_detailed_help[48];
  RNAalifold_args_info_help[37] = RNAalifold_args_info_detailed_help[49];
  RNAalifold_args_info_help[38] = RNAalifold_args_info_detailed_help[50];
  RNAalifold_args_info_help[39] = RNAalifold_args_info_detailed_help[57];
  RNAalifold_args_info_help[40] = 0; 
  
}

const char *RNAalifold_args_info_help[41];
...
void init_args_info(struct RNAalifold_args_info *args_info)
{
  ...
  args_info->noPS_help = RNAalifold_args_info_detailed_help[9] ;
  args_info->layout_type_help = RNAalifold_args_info_detailed_help[10] ;
  args_info->maxBPspan_help = RNAalifold_args_info_detailed_help[13] ;
  args_info->constraint_help = RNAalifold_args_info_detailed_help[14] ;
  args_info->shape_help = RNAalifold_args_info_detailed_help[16] ;
  args_info->shape_min = 1;
  args_info->shape_max = 0;
  args_info->shapeMethod_help = RNAalifold_args_info_detailed_help[18] ;
  args_info->partfunc_help = RNAalifold_args_info_detailed_help[22] ;
  args_info->MEA_help = RNAalifold_args_info_detailed_help[24] ;
  args_info->mis_help = RNAalifold_args_info_detailed_help[26] ;
  args_info->stochBT_help = RNAalifold_args_info_detailed_help[27] ;
  args_info->stochBT_en_help = RNAalifold_args_info_detailed_help[28] ;
  args_info->pfScale_help = RNAalifold_args_info_detailed_help[29] ;
  args_info->circ_help = RNAalifold_args_info_detailed_help[31] ;
  args_info->bppmThreshold_help = RNAalifold_args_info_detailed_help[32] ;
  args_info->gquad_help = RNAalifold_args_info_detailed_help[34] ;
  args_info->temp_help = RNAalifold_args_info_detailed_help[36] ;
  args_info->noTetra_help = RNAalifold_args_info_detailed_help[37] ;
  args_info->dangles_help = RNAalifold_args_info_detailed_help[38] ;
  args_info->noLP_help = RNAalifold_args_info_detailed_help[40] ;
  args_info->noGU_help = RNAalifold_args_info_detailed_help[42] ;
  args_info->noClosingGU_help = RNAalifold_args_info_detailed_help[43] ;
  args_info->cfactor_help = RNAalifold_args_info_detailed_help[44] ;
  args_info->nfactor_help = RNAalifold_args_info_detailed_help[45] ;
  args_info->endgaps_help = RNAalifold_args_info_detailed_help[46] ;
  args_info->ribosum_file_help = RNAalifold_args_info_detailed_help[47] ;
  args_info->ribosum_scoring_help = RNAalifold_args_info_detailed_help[48] ;
  args_info->old_help = RNAalifold_args_info_detailed_help[49] ;
  args_info->paramFile_help = RNAalifold_args_info_detailed_help[50] ;
  args_info->nsp_help = RNAalifold_args_info_detailed_help[52] ;
  args_info->energyModel_help = RNAalifold_args_info_detailed_help[54] ;
  args_info->betaScale_help = RNAalifold_args_info_detailed_help[55] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvt:C::p::s:S:cgT:4d:ER:rP:e:", long_options, &option_index);
